...
public class GrammarTest {
    ...
    private static final String MAIN_METHOD = "Start";
    private static final String INSTANCE_METHOD = "MethodDeclaration";
    private static final String STATEMENT = "Statement";
    private static final String EXPRESSION = "ExpressionEnd";
    ...
    public void testClass() {
        noErrors("class Foo extends Bar {}", "ClassDeclaration");
    }

    @Test
    public void testVarDecls() {
        noErrors("class Foo {int a; int[] b; int c; boolean d; Bar e;}", "ClassDeclaration");
    }
    ...
    public void testMainMethodEmpty() {
        noErrors("public static void main(String[] args) {}", "MethodDeclaration");
    }
